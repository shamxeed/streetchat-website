...
const PrivacyPolicy = () => {
  return (
    <Container>
      ...
      <SubTitle>Effective date: 2025-08-05</SubTitle>

      <Text>
        1. <b>Introduction</b>
      </Text>
      <Text>
        Welcome to <b> {metadata.name}</b>.
      </Text>
      <Text>
        <b>{metadata.name}</b> (“us”, “we”, or “our”) operates{' '}
        <b>{metadata.site}</b> (hereinafter referred to as <b>“Service”</b>).
      </Text>
      <Text>
        Our Privacy Policy governs your visit to <b>{metadata.site}</b>, and
      ...
      <Text>
        <b>SERVICE</b> means the {metadata.site} website operated by{' '}
        {metadata.name}.
      </Text>
      <Text>
      ...
      <Text>
        0.4. Location, Country, State, Province, ZIP/Postal code, City
      </Text>
      <Text>0.4. Contacts</Text>
      <Text>0.6. Cookies and Usage Data</Text>
      <Text>
      ...
      <Text>{metadata.name} uses the collected data for various purposes:</Text>
      ...
      <Text>
        {metadata.name} will take all the steps reasonably necessary to ensure
      ...
      <Text>0.3.1. to our subsidiaries and affiliates;</Text>
      <Text>
        0.3.2. to contractors, service providers, and other third parties we use
        to support our business;
      </Text>
      <Text>0.3.3. to fulfill the purpose for which you provide it;</Text>
      <Text>
      ...
      <Text>0.3.6. with your consent in any other cases;</Text>
      <Text>
      ...
      <Text>
        ...
        please send your request(s) by email: <b>hello@{metadata.site}</b>.
      </Text>
      <Text>
