...
import Container, { Title, SubTitle, Text } from '../misc';

const TermsAndConditions = () => {
  return (
    <Container>
      <Title>Terms and Conditions</Title>
      <SubTitle>Last updated: 2024-09-01</SubTitle>
      <Text>
        1. <b>Introduction</b>
      </Text>
      <Text>
        Welcome to <b>{metadata.name}</b> (“Company”, “we”, “our”, “us”)!
      </Text>
      <Text>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>{metadata.site}</b> (together or individually
        “Service”) operated by <b>{metadata.name}</b>.
      </Text>
      <Text>
      ...
      <Text>
        ...
        <b>hello@{metadata.site}</b> so we can try to find a solution. These
      ...
      <Text>
        ...
        following the unsubscribe link or by emailing at hello@{metadata.site}.
      </Text>
      <Text>
      ...
      <Text>
        {metadata.name} has the right but not the obligation to monitor and edit
        all Content provided by users.
      </Text>
      <Text>
        In addition, Content found on or through this Service are the property
        of {metadata.name} or used with permission. You may not distribute,
      ...
      <Text>
        ...
        {metadata.name} and its licensors. Service is protected by copyright,
        ...
        written consent of {metadata.name}.
      </Text>
      <Text>
      ...
      <Text>
        ...
        to hello@{metadata.site}, with the subject line: “Copyright
      ...
      <Text>
        You can contact our Copyright Agent via email at hello@{metadata.site}.
      </Text>
      <Text>
        12. <b>Error Reporting and Feedback</b>
      </Text>
      <Text>
        You may provide us either directly at hello@{metadata.site} or via third
      ...
      <Text>
        ...
        are not owned or controlled by {metadata.name}.
      </Text>
      <Text>
        {metadata.name} has no control over, and assumes no responsibility for
      ...
      <Text>
        ...
        email: <b>hello@streetchat.app</b>.
      </Text>{' '}
      <br />
      <br />
      <br />
